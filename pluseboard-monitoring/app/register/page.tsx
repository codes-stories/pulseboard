        ...
        <div className="grid items-center gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <GlassCard className="relative overflow-hidden min-h-[620px] order-2 lg:order-1">
            ...
            <div className="relative flex h-full flex-col justify-between p-4 md:p-8">
              ...
              <div className="rounded-md border border-[color:var(--border)] bg-[color:var(--card-solid)]/70 p-5">
                ...
                <div className="mt-3 grid gap-3 md:grid-cols-2">
                  {[
                    ...
                    "API keys",
                    "Team management",
                  ].map((item) => <div key={item} className="rounded-md border border-[color:var(--border)] px-4 py-3 text-sm">{item}</div>)}
                </div>
              </div>
            </div>
          </GlassCard>
